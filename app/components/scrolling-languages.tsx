...
const languages = [
  ...
  { name: "JavaScript", icon: <Image src="/javascript.svg" alt="JavaScript" width={48} height={48}/> },
  ...
  { name: "TypeScript", icon: <Image src="/typescript.svg" alt="TypeScript" width={48} height={48}/> },
  { name: "Visual Basic", icon: <Image src="/visualbasic.svg" alt="Visual Basic" width={48} height={48}/> },
];
const frameworks = [
