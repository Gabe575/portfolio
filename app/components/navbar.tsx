...
export default function Navbar() {
  ...
  React.useEffect(() => {
    ...
    window.addEventListener('scrollend', () => {ignoreScroll.current = false;});
    document.addEventListener('click', handleAnchorClick);

    return () => {
      window.removeEventListener('scroll', handleScroll);
      document.removeEventListener('click', handleAnchorClick);
      window.removeEventListener('scrollend', () => {ignoreScroll.current = false;});
    };
  }, []);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <a href="#projects" className="block hover:text-blue-600 dark:hover:text-blue-400">Projects</a>
