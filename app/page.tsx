      ...
      <main className="flex min-h-screen w-full flex-col items-center sm:items-start">
        ...
        >
          <div className="max-w-7xl mx-auto w-full h-full items-center flex flex-col sm:items-start sm:text-left">
            ...
            <p className="max-w-md text-lg leading-8 text-zinc-500">Software Engineer</p>
          </div>
        </section>
        ...
        <section
          id="contact"
          className="bg-darkish min-h-screen w-full pt-16 px-6 flex flex-col items-center text-center sm:items-start sm:text-left sm:px-16 md:pt-24"
        >
          <div className="max-w-7xl mx-auto w-full h-full">
      ...
      <footer className="py-12 px-6 text-sm text-zinc-500 text-center w-full bg-zinc-200 dark:bg-zinc-900 shadow-md transition-all duration-300 sm:px-16">
        <div className="max-w-7xl mx-auto flex flex-row items-center justify-between">
          ...
          <div className="flex justify-center gap-4">
            <a href="https://github.com/Gabe575" aria-label="GitHub">
              <FiGithub />
            </a>
            <a href="https://linkedin.com/in/gabriel2004santos" aria-label="LinkedIn">
              <FiLinkedin />
            </a>
          </div>
        </div>
